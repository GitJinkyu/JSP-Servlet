...
<body>
 <!-- 
	...
	콤마 출력x : <fmt:formatNumber value="${num }" groupingUsed="false"/> <br>
	...
	<h4>패턴을 지정하여 숫자를 받음</h4>
	<c:set var="num1" value="12345.0111"></c:set>
	0, # 자릿수를 의미 <br>
	0표현 : 자리에 수가 없으면 0으로 표시 - 자리수를 맞춰서 출력하고 싶을때 <br>
	#표현 : 자리에 수가 없으면 공란으로 표시 <br>
	<fmt:formatNumber value="${num1 }"></fmt:formatNumber> <br>
	...
	<fmt:parseNumber value="${num1 }" integerOnly="true" var= "saveVar"></fmt:parseNumber> <br>
	정수 부분만 : ${saveVar }
